...
### Contact Information
* *Email:* stanislawzheromsky@gmail.com
* *Mobile phone number (Viber, Telegram):* 8-033-682-98-38
* *GitHub:* zheromskyS
...
### Code examples
Here is a program finding the shortest path between 2 objects (C++):
...
Нere is a code-example оf a horizontal site menu (HTML):
```
<header class="header">
    <div class="tool-bar">
